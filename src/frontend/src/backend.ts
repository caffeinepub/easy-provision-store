...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: bigint): Promise<bigint> {
    ...
    async placeOrder(arg0: bigint, arg1: bigint, arg2: string, arg3: string): Promise<Order | null> {
        if (this.processError) {
            try {
